...
#             gr.HTML("""
#                 <div style="padding:20px; background:#fff; border-radius:15px; box-shadow:0 2px 8px rgba(0,0,0,0.07); margin-top:0;">
#                     <h2 style="color:#4a90e2; margin-bottom:10px;">🛠️ Tools Used</h2>
#                     <ul style="font-size:1.1em; line-height:2;">
#                         <li>
#                             <img src="https://raw.githubusercontent.com/gradio-app/gradio/main/assets/logo.svg" alt="Gradio" style="height:24px;vertical-align:middle;margin-right:8px;">
#                             Gradio
#                         </li>
#                         <li>
#                             <img src="https://avatars.githubusercontent.com/u/61469645?s=200&v=4" alt="LangChain" style="height:24px;vertical-align:middle;margin-right:8px;">
#                             LangChain
#                         </li>
#                         <li>
#                             <img src="https://cdn-icons-png.flaticon.com/512/5968/5968350.png" alt="Python" style="height:24px;vertical-align:middle;margin-right:8px;">
#                             Python
#                         </li>
#                     </ul>
#                 </div>
